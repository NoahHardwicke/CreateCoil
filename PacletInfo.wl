    ...
    "Extensions" -> {
      {
        "Kernel",
        "Root" -> "Kernel",
        "Context" -> {"NoahH`CreateCoil`"},
        "Symbols" -> {
          "NoahH`CreateCoil`Coil\[Phi]c",
          "NoahH`CreateCoil`Coil\[Chi]c",
          ...
          "NoahH`CreateCoil`FindLoopCoil",
          "NoahH`CreateCoil`FindSaddleCoil",
          "NoahH`CreateCoil`FindSaddleCoilAxial",
